...
<div class="px-5 py-3 font-semi font-32">
    <p class="m-0 p-0">Add New Patient</p>
</div>
<form method="POST" action="{{ route('patients.store') }}" class="px-5 py-3" style="height:85%; overflow:auto">
    @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="col">
                        <input id="first_name" type="text"
                            ...
                            value="{{ old('first_name') }}" required autocomplete="first_name" placeholder="John">
                ...
                <div class="form-group">
                    ...
                    <div class="col">
                        <input id="ic_number" type="text" class="form-control @error('ic_number') is-invalid @enderror"
                            name="ic_number" value="{{ old('ic_number') }}" required autocomplete="ic_number"
        ...
        <div class="row justify-content-between">
                ...
                <div class="form-group">
                    ...
                    <div class="col">
                        <input id="gfirst_name" type="text"
                            ...
                            value="{{ old('gfirst_name') }}" required autocomplete="gfirst_name" placeholder="john">
                ...
                <div class="form-group">
                    ...
                    <div class="col">
                        <input id="glast_name" type="text"
                            ...
                            value="{{ old('glast_name') }}" required autocomplete="glast_name" placeholder="doe">
                ...
                <div class="form-group">
                    ...
                    <div class="col">
                        <input id="contact" type="text" class="form-control" name="contact" required minlength="10"
                            maxlength="11" placeholder="0134402331" onkeypress="return isNumberKey(event)">
            ...
            <div class="col-4">
                <div class="form-group">
                    ...
                    <div class="col">
                        <input id="postcode" type="text" class="form-control" name="postcode" required
                            placeholder="43000" minlength="5" maxlength="5" onkeypress="return isNumberKey(event)">
                ...
                <div class="form-group">
                    ...
                    <div class="col">
                        <input id="city" type="text" class="form-control" name="city" placeholder="Kajang" required>
    ...
    <div class="col mx-0 mb-3 p-3  backbone-panel">
        ...
        <div class="row justify-content-between">
            <div class="col-4">
                {{-- patient account --}}
                <div class="form-group">
                    <label for="username" class="col col-form-label">{{ __('User Account') }}</label>

                    <div class="col">
                        <input id="username" type="text" class="form-control @error('username') is-invalid @enderror"
                            name="username" value="{{ old('username') }}" placeholder="johndoe97" required>
                ...
                <div class="form-group">
                    ...
                    <div class="col">
                        <input id="password-confirm" type="password" class="form-control" name="password_confirmation"
                            placeholder="Confirm Account Password" required autocomplete="new-password">
                    </div>
                </div>
            </div>
        </div>
