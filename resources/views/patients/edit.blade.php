                    ...
                    <form method="POST" action="{{ route('patients.update',[$patient->id]) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="last_name" type="text"
                                    ...
                                    value="{{$patient->last_name}}" required autocomplete="last_name" placeholder="Doe">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="ic_number" type="text"
                                    ...
                                    value="{{ $patient->ic_number }}" required autocomplete="ic_number"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="gender" class="form-control" name="gender" required>
                                    ...
                                    <option value="{{$key}}" {{$patient->gender == $key ? "selected" : ""}}>{{$item}}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="age" class="form-control" name="age" required>
                                    ...
                                    <option value="{{$key}}" {{$patient->age == $key ? "selected" : ""}}>{{$item}}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="cancer" class="form-control" name="cancer" required>
                                    ...
                                    <option value="{{$key}}" {{$patient->cancer == $key ? "selected" : ""}}>{{$item}}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="gfirst_name" type="text"
                                    ...
                                    value="{{ $guardian->first_name }}" required autocomplete="gfirst_name"
                                    placeholder="john">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="glast_name" type="text"
                                    ...
                                    value="{{ $guardian->last_name }}" required autocomplete="glast_name"
                                    placeholder="doe">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="relations" class="form-control" name="relations" required>
                                    ...
                                    <option value="{{$key}}" {{$patient->relations == $key ? "selected" : ""}}>{{$item}}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="contact" type="text" class="form-control" name="contact" required
                                    ...
                                    onkeypress="return isNumberKey(event)" value="{{$guardian->contact}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="address_one" type="text" class="form-control" name="address_one"
                                    placeholder="1, Jalan Damai" value="{{$guardian->address_one}}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="address_two" type="text" class="form-control" name="address_two"
                                    placeholder="Bandar Sg Long" value="{{$guardian->address_two}}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="postcode" type="text" class="form-control" name="postcode" required
                                    ...
                                    onkeypress="return isNumberKey(event)" value="{{$guardian->postcode}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="state" class="form-control" name="state" required>
                                    ...
                                    <option value="{{$key}}" {{$patient->state == $key ? "selected" : ""}}>{{$item}}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit"
                                    onclick="return confirm('Are you sure to update the profile with new details?')"
