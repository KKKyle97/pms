...
<div class="patient-list py-3" style="height:100vh; overflow:auto">
    <div class="py-3 font-semi font-32">
        <p class="m-0 p-0">Analysis</p>
    </div>
    <div class="backbone-panel px-5 py-3 position-relative" style="height:75vh; overflow:auto">
        <div class="pb-3">
        ...
        <div id="body-parts-chart-div" class="w-75 h-50 position-absolute">
        </div>
        
        <div id="dashboard_div" class=" w-75 h-50 position-absolute">
            <!--Divs that will hold each control and chart-->
            <div id="filter_div" class="w-75"></div>
            <div id="chart_div" class=" h-100"></div>
        </div>

        <div id="dashboard2_div" class=" w-75  h-50 position-absolute">
            <!--Divs that will hold each control and chart-->
            <div id="filter2_div" class="pb-3 w-75"></div>
            <div id="chart2_div" class=" h-100"></div>
        </div>

        <div id="dashboard3_div" class=" w-75  h-50 position-absolute">
            <!--Divs that will hold each control and chart-->
        ...
        <div id="dashboard4_div" class=" w-75  h-50 position-absolute">
            <!--Divs that will hold each control and chart-->
            <div id="filter4_div" class="w-75"></div>
            <div id="chart4_div" class="h-100"></div>
        </div>

        <div id="dashboard5_div" class=" w-75  h-50 position-absolute">
            <!--Divs that will hold each control and chart-->
