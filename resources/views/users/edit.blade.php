...
<div class="patient-list py-3" style="height:100vh; overflow:auto">
    <p class="m-0 pb-3 font-semi font-32" align="center">Update Profile</p>
    <form method="POST" action="{{ route('users.update',[$userProfile->id]) }}" class="py-3"
        >
        @csrf
        @method('PUT')
    
        {{-- user profile --}}
        <div class="col-sm mx-0 mb-3 p-3 backbone-panel">
            ...
            <div class="form-group">
                ...
                <div class="col dropdown">
                    <select id="hospital" style="width:100%" class="form-control js-example-basic-single" name="hospital" required>
