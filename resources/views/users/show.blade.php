...
<div class="patient-list py-5 middle" align="center">
    <div class="user-profile-card card-front d-flex flex-column align-items-center" align="center">
    ...
    <div class="pt-3 m-0 d-flex justify-content-center">
        <a class="btn btn-normal btn-custom-width mr-2" href="{{route('users.edit',[$userProfile->id])}}">Update
            Details</a>
